...
# Admin Dashboard Endpoints - REMOVED: Now handled by Flask-Admin
# The following routes are redundant since we're using Flask-Admin interface:
# - /admin/dashboard (Flask-Admin provides dashboard)
# - /admin/quick-actions (Flask-Admin has action buttons)
# - /admin/analytics/summary (Flask-Admin can show analytics)

# Todo the remaining end points we need from the uml.md as discussed in the meeting.
